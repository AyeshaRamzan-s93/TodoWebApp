...
// import nextIcon from "../../../../assets/icons_arrow-left.svg";
// import timerDot from "../../../../assets/Semiclone.png";
...
//               </div>
//               <div className="sale-info">
//                 <p className="sale-title">Gaming Keyboard</p>
//                 <p className="sale-price">
//                   $120 <span className="old-price">$160</span>
//                 </p>
//                 <div className="sale-rating">
...
//               </div>
//               <div className="sale-info">
//                 <p className="sale-title">Gaming Monitor</p>
//                 <p className="sale-price">
//                   $120 <span className="old-price">$160</span>
//                 </p>
//                 <div className="sale-rating">
...
//               </div>
//               <div className="sale-info">
//                 <p className="sale-title">Ergonomic Chair</p>
//                 <p className="sale-price">
//                   $120 <span className="old-price">$160</span>
//                 </p>
//                 <div className="sale-rating">
...
//               </div>
//               <div className="sale-info">
//                 <p className="sale-title">Office Chair</p>
//                 <p className="sale-price">
//                   $120 <span className="old-price">$160</span>
//                 </p>
//                 <div className="sale-rating">
